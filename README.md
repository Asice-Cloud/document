...
​	<img src="assets/awesomeface.png" width=25px>非常感谢各位能够阅读到这里。时代在发展，计算机知识已经成为了现代社会生存必要技能。希望本文档和后续培训能够对各位起到帮助。本文档由:cupid:孙源隆，:pizza:王俊杰, :kiss:陈冠余共同编写，也感谢对文档提出指导和改进意见的所有人。
